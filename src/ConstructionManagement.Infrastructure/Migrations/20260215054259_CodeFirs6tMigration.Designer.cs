...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260215054259_CodeFirs6tMigration")]
    partial class CodeFirs6tMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 15, 5, 42, 52, 726, DateTimeKind.Utc).AddTicks(5466)
                        });
                });
