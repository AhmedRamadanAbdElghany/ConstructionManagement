...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260227183723_CodeFirst53Migration")]
    partial class CodeFirst53Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 27, 18, 37, 17, 133, DateTimeKind.Utc).AddTicks(5599)
                        });
                });
