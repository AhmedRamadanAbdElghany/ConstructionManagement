...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260222002821_AddWarehouseMarketplaceFeatures")]
    partial class AddWarehouseMarketplaceFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 22, 0, 28, 16, 200, DateTimeKind.Utc).AddTicks(9293)
                        });
                });
