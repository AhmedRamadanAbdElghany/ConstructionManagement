...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260214202126_AddRequestedRoleToJoinRequest")]
    partial class AddRequestedRoleToJoinRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 14, 20, 21, 21, 192, DateTimeKind.Utc).AddTicks(1005)
                        });
                });
