        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableLocationTracking = table.Column<bool>(type: "bit", nullable: false),
                    EnableGeofenceManagement = table.Column<bool>(type: "bit", nullable: false),
                    EnableLocationSubmit = table.Column<bool>(type: "bit", nullable: false),
                    EnableInspections = table.Column<bool>(type: "bit", nullable: false),
                    EnableLeaveManagement = table.Column<bool>(type: "bit", nullable: false),
                    EnablePerformanceEvaluation = table.Column<bool>(type: "bit", nullable: false),
                    EnableTrainingTracking = table.Column<bool>(type: "bit", nullable: false),
                    EnableTasks = table.Column<bool>(type: "bit", nullable: false),
                    EnableEscalations = table.Column<bool>(type: "bit", nullable: false),
                    EnableMessaging = table.Column<bool>(type: "bit", nullable: false),
                    EnableSocialWall = table.Column<bool>(type: "bit", nullable: false),
                    EnableCurrencies = table.Column<bool>(type: "bit", nullable: false),
                    EnablePaymentGateway = table.Column<bool>(type: "bit", nullable: false),
                    EnableMarketplace = table.Column<bool>(type: "bit", nullable: false),
                    EnableInventoryOwner = table.Column<bool>(type: "bit", nullable: false),
                    EnableVideoCalls = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 99, null, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Create and manage geofence zones", false, "Geofence.Manage", null },
