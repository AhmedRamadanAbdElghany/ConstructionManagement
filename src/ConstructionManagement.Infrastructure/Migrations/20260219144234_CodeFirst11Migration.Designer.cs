...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260219144234_CodeFirst11Migration")]
    partial class CodeFirst11Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 19, 14, 42, 26, 556, DateTimeKind.Utc).AddTicks(3311)
                        });
                });
