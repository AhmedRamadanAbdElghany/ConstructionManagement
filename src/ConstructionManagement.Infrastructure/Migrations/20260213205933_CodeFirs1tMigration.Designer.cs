...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260213205933_CodeFirs1tMigration")]
    partial class CodeFirs1tMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 13, 20, 59, 29, 89, DateTimeKind.Utc).AddTicks(976)
                        });
                });
