...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260227030435_AddIsPrimaryToCompanyUser")]
    partial class AddIsPrimaryToCompanyUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 27, 3, 4, 24, 360, DateTimeKind.Utc).AddTicks(2497)
                        });
                });
