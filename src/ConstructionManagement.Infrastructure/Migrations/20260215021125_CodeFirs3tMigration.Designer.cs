...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260215021125_CodeFirs3tMigration")]
    partial class CodeFirs3tMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 15, 2, 11, 19, 750, DateTimeKind.Utc).AddTicks(6264)
                        });
                });
