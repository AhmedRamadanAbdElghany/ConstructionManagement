...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260221143304_AddUserPushNotificationSettings")]
    partial class AddUserPushNotificationSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 21, 14, 32, 59, 311, DateTimeKind.Utc).AddTicks(7239)
                        });
                });
