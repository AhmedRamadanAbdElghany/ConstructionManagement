...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260301212855_CodeFirstMigratio2n")]
    partial class CodeFirstMigratio2n
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 3, 1, 21, 28, 43, 57, DateTimeKind.Utc).AddTicks(6153)
                        });
                });
