...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260216014958_CodeFirst1Migration")]
    partial class CodeFirst1Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 16, 1, 49, 52, 661, DateTimeKind.Utc).AddTicks(1045)
                        });
                });
