...
namespace ConstructionManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260301013525_CodeFirstMigratio1n")]
    partial class CodeFirstMigratio1n
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 3, 1, 1, 35, 9, 676, DateTimeKind.Utc).AddTicks(8955)
                        });
                });
