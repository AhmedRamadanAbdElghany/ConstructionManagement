...
namespace ConstructionManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260222185731_AddVendorAndSocialMediaFeatures")]
    partial class AddVendorAndSocialMediaFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ConstructionManagement.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            RoleId = 1,
                            AssignedAt = new DateTime(2026, 2, 22, 18, 57, 25, 673, DateTimeKind.Utc).AddTicks(2875)
                        });
                });
