...
/// <summary>
/// Historical snapshot of profitability calculation for a specific Project Item
/// Used to track profit/loss trend over time (daily, weekly, or on-demand logs)
/// </summary>
public class ProjectItemProfitabilityLog : BaseEntity, ICompanyEntity
{
    public int? CompanyId { get; set; }

    // Which Project Item this profitability snapshot refers to
    ...
    /// <summary>
    /// Total approved/actual costs spent on this item up to LogDate
    /// (materials + labor + subcontractors + overheads allocated)
    /// </summary>
    public decimal TotalSpent { get; set; }

    /// <summary>
    /// Contracted/estimated revenue/budget allocated for this item
