      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-10">
          ...
          <h1 class="text-3xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">
            My Projects <span class="text-indigo-500">📁</span>
          </h1>
          <p class="text-slate-500 dark:text-slate-400 font-medium">Projects you are assigned to</p>
        </div>
        ...
        @if (!loading) {
          @if (projects.length === 0) {
            <div class="bg-white dark:bg-slate-900 rounded-[3rem] p-12 border border-slate-200 dark:border-white/5 shadow-xl text-center">
              ...
              <h3 class="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-2">No Projects Assigned</h3>
              <p class="text-slate-500 dark:text-slate-400 font-medium">You haven't been assigned to any projects yet.</p>
            </div>
          } @else {
                ...
                <div class="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-white/5 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300 overflow-hidden group">
                  ...
                  <div class="px-6 py-4 bg-slate-50 dark:bg-slate-800/50">
                    <div class="grid grid-cols-2 gap-4 text-center">
                      <div>
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">Start Date</p>
                        <p class="text-sm font-bold text-slate-900 dark:text-white">{{ project.startDate | date:'MMM d, y' }}</p>
                      </div>
                      <div>
                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">End Date</p>
