...
export class PendingRequestsComponent implements OnInit {
  ...
  initConfigForm() {
    ...
    this.configForm = this.fb.group({
      ...
      packageId: [defaults.packageId, Validators.required],
      ...
      enableInventoryManagement: [defaults.enableInventoryManagement],
      enableQualityControl: [defaults.enableQualityControl],
      enableSafetyManagement: [defaults.enableSafetyManagement],
      enableSubcontractorManagement: [defaults.enableSubcontractorManagement],
      enableFinancialManagement: [defaults.enableFinancialManagement],
      enableAnalytics: [defaults.enableAnalytics],
      enableNotifications: [defaults.enableNotifications],
      enableDocumentManagement: [defaults.enableDocumentManagement],
      enableDesignManagement: [defaults.enableDesignManagement],
      enableClientPortal: [defaults.enableClientPortal],
      enableAccessControl: [defaults.enableAccessControl],
      enableHRManagement: [defaults.enableHRManagement],
      enableVendorManagement: [defaults.enableVendorManagement],
      enableDelayNotification: [defaults.enableDelayNotification],
      requirePhotoReview: [defaults.requirePhotoReview],
      clientCanSeeFinancials: [defaults.clientCanSeeFinancials],
      allowMeasured: [defaults.allowMeasured],
      allowSupervision: [defaults.allowSupervision],
      allowPackages: [defaults.allowPackages],
      allowLocations: [defaults.allowLocations],
      allowHR: [defaults.allowHR],
      requireMaterialRequestApproval: [defaults.requireMaterialRequestApproval],
      materialRequestApproverRole: [defaults.materialRequestApproverRole],
      enableMultiWarehouse: [defaults.enableMultiWarehouse],
      enableStockAlerts: [defaults.enableStockAlerts],
      defaultLowStockThreshold: [defaults.defaultLowStockThreshold],
      enableEquipmentMaintenanceScheduling: [defaults.enableEquipmentMaintenanceScheduling],
      enableEquipmentUtilizationTracking: [defaults.enableEquipmentUtilizationTracking],
      enableEquipmentGpsTracking: [defaults.enableEquipmentGpsTracking],
      enableEquipmentRentalBilling: [defaults.enableEquipmentRentalBilling],
      equipmentMaintenanceAlertThreshold: [defaults.equipmentMaintenanceAlertThreshold],
      allowAddProgressEntry: [defaults.allowAddProgressEntry],
      allowReopenClosedDay: [defaults.allowReopenClosedDay],
  ...
  openConfigModal(request: CompanyRequest) {
    ...
    // Reset form to defaults first to prevent state leakage
    this.configForm.reset(this.getDefaultConfig());
    // Then patch specifically with request data
